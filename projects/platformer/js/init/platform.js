(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(400, 465, 0.75);
        platform.create(500, 200);
        platform.create(0, 550, 0.5, 0.5);
        platform.create(60, 400, 0.5, 0.5);
        platform.create(425, 299, 0.35, 0.75);
        platform.create(180, 180, 0.25, 0.5);
        //platform.create(50, 285, 0.45, 0.5);
        platform.create(380, 330, 0.15, 0.5);
